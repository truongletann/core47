...
export default async function List100Page() {
    ...
    <main className="mx-auto max-w-7xl px-6 py-16">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-3 text-sm leading-relaxed text-[rgb(var(--muted))]">
          ...
          quiet adventures, and a few things that scare me a little. This list keeps changing as
          I do; got a suggestion for something worth adding? Send it my way.
        </p>
